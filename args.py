...
def parse_args():
    ...
    parser.add_argument("--prompt_from_file", type=str, default="examples/prompt_inputs.json", help="if specified, load prompts from this file, separated by json elements")
